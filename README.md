# Curation [![Build Status](https://secure.travis-ci.org/VirtualFlyBrain/curation.svg?branch=dosumis_curation)](http://travis-ci.org/VirtualFlyBrain/curation?branch=dosumis_curation)
